...
public class StoryboardClient {
  ...
  public void putData(final String url, final String data)
      throws IOException {
  ...
  public void addNote(final String issueId, final String note)
      throws IOException {
    log.debug("PUT task with data: ({},{})", issueId, note);
    final String url = baseUrl + TASKS_ENDPOINT + "/" + issueId;
    final String json =
        "{\"task_id\":\"" + issueId + "\",\"link\":\"" + note + "\"}";

    putData(url, json);
  }

  public String getTaskStatus(final String issueId)
      throws IOException {
    String taskJson = getTask(issueId);
    JsonObject jobj = new Gson().fromJson(taskJson, JsonObject.class);
  ...
  public String getTaskNotes(final String issueId)
      throws IOException {
    String taskJson = getTask(issueId);
    JsonObject jobj = new Gson().fromJson(taskJson, JsonObject.class);
